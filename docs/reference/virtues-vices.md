...
This article presents each intellectual virtue
...
Intellectual Servility/Self-Denigration (Excess)
...
INT. DISTRACTION ←―――――――― ATTENTIVENESS ―――――――――→ HYPER-VIGILANCE/OBSESSIVENESS
    (Deficiency)             (Virtue)                 (Excess)

    Mind constantly         Mentally present,         Unable to shift
    elsewhere              focused                   attention
    
    "Wait, what?"          "I'm paying              "I can't stop
                          attention"                thinking about this"


Intellectual Distraction (Deficiency)
...
INT. CARELESSNESS ←―――――――― INT. CAREFULNESS   ―――――――――→ INT. SCRUPULOSITY/PERFECTIONISM
    (Deficiency)            (Virtue)                  (Excess)

    Sloppy,                Accurate,                 Paralyzed by
    hasty                  precise                   fear of error
    
    "Good enough"          "Let me check            "It's never
                          this"                     perfect enough"

Intellectual Carelessness (Deficiency)
...
Intellectual Carefulness (Virtue)
...
Intellectual Scrupulosity/Perfectionism (Excess)
...
INT. SUPERFICIALITY ←――――――――  INT. THOROUGHNESS  ―――――――――→ INT.  PEDANTRY
    (Deficiency)            (Virtue)                 (Excess)

    Surface-level          Deep, seeks              Unnecessarily
    only                   connections              exhaustive
    
    "Got it"              "But why?"               "Actually, we need
    (doesn't really)                               to consider 47
                                                   more factors..."


Intellectual Superficiality (Deficiency)
...
Intellectual Thoroughness (Virtue)
...
INT. CLOSED-MINDEDNESS ←――――― OPEN-MINDEDNESS   ―――――――→ INT. GULLIBILITY
    (Deficiency)             (Virtue)                (Excess)

    Rigid,                 Considers                Uncritical,
    dogmatic               alternatives             accepts anything
    
    "I'm right,           "Let me consider         "Sure, that
    period"               your perspective"        sounds right"

Intellectual Closed-Mindedness (Deficiency)
...
Intellectual Gullibility (Excess)
...
INT. COWARDICE ←―――――――――― INT. COURAGE ―――――――――→ INT. RECKLESSNESS
    (Deficiency)            (Virtue)                 (Excess)

    Fear prevents         Persists despite         No regard for
    learning              fear                     genuine risks
    
    "I can't            "This is scary,          "Hold my beer,
    speak up"           but important"           watch this"


Intellectual Cowardice (Deficiency)
...
Intellectual Recklessness (Excess)
...
INT. LAZINESS/QUITTING ←――――― INT. TENACITY ―――――――――→ INT. STUBBORNNESS
    (Deficiency)            (Virtue)                 (Excess)

    Gives up              Persists                 Won't give up
    easily                intelligently            even when appropriate
    
    "This is too         "Let me try a           "I'll never stop
    hard"                different approach"      trying this exact
                                                 same way"


Intellectual Laziness/Quick Quitting (Deficiency)
...
Intellectual Stubbornness (Excess)
...
LEARNING INITIATORS:
Apathy              ←――― CURIOSITY ―――→              Nosiness
Conformity          ←――― AUTONOMY ―――→               Dogmatism
Arrogance           ←――― HUMILITY ―――→               Servility

LEARNING MAINTAINERS:
Distraction         ←――― ATTENTIVENESS ―――→          Hyper-vigilance
Carelessness        ←――― CAREFULNESS ―――→            Perfectionism
Superficiality      ←――― THOROUGHNESS ―――→           Pedantry

OBSTACLE OVERCOMERS:
Closed-mindedness   ←――― OPEN-MINDEDNESS ―――→        Gullibility
Cowardice           ←――― COURAGE ―――→                Recklessness
Laziness/Quitting   ←――― TENACITY ―――→               Stubbornness
