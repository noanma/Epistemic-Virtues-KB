# Facilitating Your First Socratic Seminar

## Overview

This tutorial guides you through planning and facilitating your first Socratic seminar. It is a structured discussion format that practices multiple intellectual virtues simultaneously. By the end, you'll have led a meaningful dialogue where students think together, challenge ideas respectfully, and experience the value of collaborative inquiry.

**Target Audience:** This tutorial is primarily designed for:
- 
...
**Important:** Your first Socratic seminar will feel messy. That's normal and actually desirable. The goal is meaningful struggle with ideas, not polished performance.
...
- Think out loud and change their minds
...
- A free-for-all (there's structure and purpose)
...
- **Attentiveness** (listening carefully to others)
- **Curiosity** (asking genuine questions)
- **Intellectual autonomy** (forming your own judgments)

---

## Two Weeks Before: Selecting Your Text or Question
...
- A philosophical thought experiment (trolley problem variations)
- A poem with multiple interpretations
- A scientific concept with ethical implications
...
- Rich enough to sustain 45+ minutes of conversation
...
## One Week Before: Preparing Students

### Day 1: Introduce the Format

**Task:** Explain what a Socratic seminar is and why it matters.

**How:**
1. Say something like:
   
   "Next week, we're going to try something called a Socratic seminar. It's named after Socrates, an ancient Greek philosopher who believed the best way to understand something was through dialogue—asking questions and thinking together.
   
   In a Socratic seminar, YOU will lead the discussion. My job is just to help keep it going. Your job is to think together about a question that doesn't have easy answers.
   
   This will probably feel different from regular class discussions. There's no 'right answer' I'm looking for. I'm genuinely curious what you'll discover together."

2. Explain the basic structure:
   - We'll sit in a circle (or outer/inner circle for larger classes)
   - I'll pose an opening question
   - You'll discuss while I mostly listen
   - The goal is to think together, not win an argument
...
### Day 2-3: Introduce Discussion Norms

**Task:** Co-create norms for respectful, productive dialogue.

**How:**
1. Ask: "What makes a discussion feel safe and productive? What makes it feel uncomfortable or pointless?"

2. Collect student ideas and add essential ones they miss:
   - Listen to understand, not just to respond
   - Refer to the text/question, not just opinions
   - Challenge ideas, not people
   - Make space for others to speak
   - It's okay to change your mind
   - It's okay to say "I'm not sure" or "I need to think about that"
   - Build on what others say ("Building on what Alex said...")
   - Ask genuine questions

3. Frame these as practicing intellectual virtues:
   - Listening to understand = **attentiveness** and **open-mindedness**
   - Challenging ideas respectfully = **intellectual courage** and **humility**
   - Saying "I'm not sure" = **intellectual humility**
   - Building on others = **curiosity** and **thoroughness**
...
### Day 4: Teach "Talk Moves"

**Task:** Give students concrete language for participating well.
...
### Day 5: Assign the Reading/Preparation

**Task:** Have students engage with the text or question before the seminar.
...
2. Ask students to prepare by:
   ...
   - Identifying one place where they're uncertain or could see multiple perspectives

3. Optional: Use a thinking routine like "I Notice / I Wonder" or "See-Think-Wonder" (see Chapter 8)
...
## The Day Before: Your Final Preparation

### Task: Prepare yourself as facilitator
...
1. **Prepare 3-5 opening questions** of increasing depth:
   ...
   - Level 4 (evaluative): "Do you agree with the text's assumptions?"
   - Level 5 (personal/philosophical): "How does this connect to your own experience?"
...
6. **Mentally prepare yourself:**
   ...
   - Model intellectual humility by being genuinely curious about their thinking

**Why this matters:**  
As Baehr emphasizes, teaching postures matter as much as practices (Chapter 4). Your presence, openness, and humility will set the tone.

**What success looks like:**  
You feel prepared but not rigidly planned. You're genuinely curious what students will say. You're ready to follow their thinking, not your agenda.

---

## Day Of: The Seminar Structure (60 minutes)

### Opening (5 minutes)

**Task:** Set the tone and launch the discussion.

**How:**
1. Welcome students and acknowledge any nervousness (yours and theirs)

2. Briefly review norms

3. Remind them of the goal:
   "We're here to think together. You'll run this discussion. I'm going to mostly listen and occasionally ask a question. There's no hidden 'right answer' I'm waiting for. I'm genuinely curious what we'll discover together."

4. Pose your opening question (start with Level 1 or 2)

5. Give 30-60 seconds of silence for thinking
...
- **Redirect to the text/question** if discussion goes off track
- **Name intellectual virtues** when you see them
...
- **Open-mindedness**: students considering views different from their own
- **Curiosity**: students asking genuine questions of each other
...
- There's productive disagreement
- Some silence for thinking
...
- Unsafe silence (>20 seconds with no thinking happening)

---

### Closing (10 minutes)

**Task:** Help students reflect on the discussion and their thinking.
...
4. Invite a few to share their reflections
...
**What success looks like:**  
Students can articulate how their thinking changed or deepened. They recognize they practiced virtues. Some express wanting to do this again.

---

## Immediately After: Your Reflection

### Task: Reflect while it's fresh
...
**Why this matters:**  
Reflection supports your own growth as a facilitator. You'll learn as much from the first seminar as your students did.

---

## The Next Day: Student Debrief

### Task: Help students process the experience
...
**Why this matters:**  
As Baehr notes, "Reflection and self-awareness" support virtue development (Chapter 6). Debriefing helps students recognize what they practiced and how they can grow.

**What success looks like:**  
Students recognize specific intellectual virtues they practiced. They identify areas for growth. Most express interest in trying again.
...
- Begun building students' capacity for virtuous dialogue
- Taken a significant risk as an educator (releasing control is hard!)

**This is major growth work**—for you and your students.
...
- Seminars focused on specific virtues
...
- Very concrete norms and talk moves
...
- Lower stakes: "Turn to someone and share what you're thinking"
...
- Learn from it and try again—each one gets better

---

## A Final Word

Your first Socratic seminar will not be perfect.

You will talk too much or too little. Students will go off-topic. There will be awkward silences. Someone will say something you disagree with and you'll struggle not to correct them.

**All of this is normal.**

What matters is that you created a space where students had to think—really think—together. Where they practiced intellectual virtues not by hearing about them, but by doing them.

As Baehr reminds us, "Intellectual virtues are formed through repeated practice over time" (Chapter 8). This seminar is one practice session. There will be many more.

Each seminar will be different. Each one will teach you something. Each one will help your students grow as thinkers.

You're not behind. You're not doing it wrong.

You're learning alongside your students, which is exactly what intellectually humble educators do.

And that's the best modeling you can offer.